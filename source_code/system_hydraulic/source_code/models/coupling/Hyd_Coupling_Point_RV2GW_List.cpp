...
//constructor
Hyd_Coupling_Point_RV2GW_List::Hyd_Coupling_Point_RV2GW_List(void) {
	this->number = 0;
	this->points = NULL;
	this->mid_river_flag = true;
	this->left_river_flag = false;
	//count the memory
	Sys_Memory_Count::self()->add_mem(sizeof(Hyd_Coupling_Point_RV2GW_List), _sys_system_modules::HYD_SYS);
...
Hyd_Coupling_Point_RV2GW_List::~Hyd_Coupling_Point_RV2GW_List(void) {
	this->delete_list();
	//count the memory
	Sys_Memory_Count::self()->minus_mem(sizeof(Hyd_Coupling_Point_RV2GW_List), _sys_system_modules::HYD_SYS);
}
//_____________
//public
//Get the number of coupling points
int Hyd_Coupling_Point_RV2GW_List::get_number_couplings(void) {
	return this->number;
}
//Get the total list as a pointer
Hyd_Coupling_Point_RV2GW* Hyd_Coupling_Point_RV2GW_List::get_total_list(void) {
	return this->points;
}
//Get a specific coupling pointswith the given index
Hyd_Coupling_Point_RV2GW Hyd_Coupling_Point_RV2GW_List::get_couplingpoint(const int index) {
	return this->points[index];
}
//Get a pointer to specific coupling points with the given index
Hyd_Coupling_Point_RV2GW* Hyd_Coupling_Point_RV2GW_List::get_ptr_couplingpoint(const int index) {
	Hyd_Coupling_Point_RV2GW* ptr = NULL;
...
Hyd_Coupling_Point_RV2GW* Hyd_Coupling_Point_RV2GW_List::get_next_point_upwards(Hyd_Coupling_Point_RV2GW* coupling_point) {
	Hyd_Coupling_Point_RV2GW* pointer = NULL;
...
Hyd_Coupling_Point_RV2GW* Hyd_Coupling_Point_RV2GW_List::get_next_point_downwards(Hyd_Coupling_Point_RV2GW* coupling_point) {
	Hyd_Coupling_Point_RV2GW* pointer = NULL;
...
Hyd_Coupling_Point_RV2GW Hyd_Coupling_Point_RV2GW_List::get_first_couplingpoint(void) {
	return this->points[0];
}
//Get the last coupling points of the list
Hyd_Coupling_Point_RV2GW Hyd_Coupling_Point_RV2GW_List::get_last_couplingpoint(void) {
	return this->points[this->number - 1];
}
//Output the setted members
void Hyd_Coupling_Point_RV2GW_List::output_setted_members(ostringstream *cout) {
	*cout << "No.,";
	Hyd_Coupling_Point_RV2GW::output_header_setted_member(cout);
...
void Hyd_Coupling_Point_RV2GW_List::set_new_couplingpoint(Hyd_Coupling_Point_RV2GW *new_point) {
	...
	if (this->number != 0 && this->number % this->block_elems != 0) {
		...
		//allocate a buffer
		Hyd_Coupling_Point_RV2GW *buffer = NULL;
		...
		try {
			...
			buffer = new Hyd_Coupling_Point_RV2GW[full_blocks*this->block_elems];
			//buffer=new Hyd_Coupling_Point_RV2GW[this->number];
		}
		catch (bad_alloc &) {
...
void Hyd_Coupling_Point_RV2GW_List::set_leftriver_bank_line(const bool flag) {
	this->left_river_flag = flag;
}
//Get if it is the left river bank line or the right one (in flowdirection) 
bool Hyd_Coupling_Point_RV2GW_List::get_leftriver_bank_line(void) {
	return this->left_river_flag;
}

///Set if it is mid river line
void Hyd_Coupling_Point_RV2GW_List::set_midtriver_line(const bool flag) {
	this->left_river_flag = flag;
}
//Get if it is the mid river line
bool Hyd_Coupling_Point_RV2GW_List::get_midriver_line(void) {
	return this->left_river_flag;
}
...
Hyd_Coupling_Point_RV2GW* Hyd_Coupling_Point_RV2GW_List::find_coupling_point(const double distance, _Hyd_Coupling_Point *point) {
	Hyd_Coupling_Point_RV2GW *pointer = NULL;
...
Hyd_Coupling_Point_RV2GW* Hyd_Coupling_Point_RV2GW_List::find_coupling_point(const double distance) {
	Hyd_Coupling_Point_RV2GW *pointer = NULL;
	for (int i = 0; i < this->number; i++) {
		if (this->points[i].distance_along_polysegment >= distance) {
			pointer = &this->points[i];
...
/*
//Insert two coupling point in the list from the given midpoint of a structure or riverjunction up- and downstream and set a stop break flag and a no overflow flag TODO Check if necessarry
void Hyd_Coupling_Point_RV2GW_List::insert_constricting_coupling_points(const double width, _Hyd_Coupling_Point *mid_point) {
	//pointer to the already existing coupling point related to the upstream inserting point
	Hyd_Coupling_Point_RV2GW *point_upstream;
	//pointer to the already existing coupling point relatedto the downstream inserting point
	Hyd_Coupling_Point_RV2GW *point_downstream;
	//point which will be insert upstream of the structure/junction
	Hyd_Coupling_Point_RV2GW insert_upstream;
	//point which will be insert downstream of the structure/junction
	Hyd_Coupling_Point_RV2GW insert_downstream;
...
void Hyd_Coupling_Point_RV2GW_List::add_additional_coupling_points(void) {
...
bool Hyd_Coupling_Point_RV2GW_List::find_distance2related_profile(const int related_profile_index, double *distance) {
...
//Delete the list
void Hyd_Coupling_Point_RV2GW_List::delete_list(void) {
	this->delete_couplingpoints();
	this->number = 0;
}
//Sort the points after the distance to the beginning of the defining polysegment
void Hyd_Coupling_Point_RV2GW_List::sort_distance_along_polysegment(void) {
	this->calculate_distances();
	//make the buffer for sorting
	Hyd_Coupling_Point_RV2GW swap;
	int j = 0;
...
void Hyd_Coupling_Point_RV2GW_List::calculate_alldistance_up_down(void) {
...
void Hyd_Coupling_Point_RV2GW_List::assign_point2polysegment(void) {
	int point = 0;
	int rv = 0;
	for (int i = 0; i < this->number; i++) {

		rv = 0;
		for (int j = 0; j < (this->defining_polysegment->get_number_segments()); j++) {
			
			//check if point is relevant=> it is inside the groundwater boundary
			if (this->defining_polysegment->my_segment[j].calc_point_on_segment(&(this->points[i])) == true) {
				this->points[point].set_rv_indices(rv);
				break;
			}
			rv++;
		}
...
//Add the relevant coupling points of the defining_polysegment TODO check transformation of floodplain to groundwater polygon
void Hyd_Coupling_Point_RV2GW_List::add_relevant_polysegment_points(Hyd_Groundwater_Polygon *gw_boundary) {
	//sort it before
	this->sort_distance_along_polysegment();
	...
	for (int i = 1; i < old_number; i++) {
		if (abs(this->points[i].river_profile_index_up - this->points[i - 1].river_profile_index_up) != 0) {
			...
			for (int j = start_index; j < end_index; j++) {
				//check if point is relevant=> it is inside the groundwater boundary
				if (gw_boundary->check_point_inside(&(this->defining_polysegment->my_segment[j].point2)) == true) {
					buffer.set_point(&(this->defining_polysegment->my_segment[j].point2));
					buffer.set_groundwater_index(this->points[i-1].get_groundwater_index());
					buffer.set_indices(j+1, this->points[i-1].groundwater_elem_index);
					buffer.set_pointer_groundwater_element(this->points[i-1].groundwater_elem);
					buffer.set_point_name(hyd_label::coupling_point_RV2GW);
					this->set_new_couplingpoint(&buffer);
				}
			}
	...
	//check if the first profil and the last profile inside the gw-polygon
	...
	if (this->number > 0) {
		...
		do {
			//check if point is relevant=> it is inside the groundwater boundary
			if (gw_boundary->check_point_inside(&(this->defining_polysegment->my_segment[counter].point1)) == true) {
				buffer.set_point(&(this->defining_polysegment->my_segment[counter].point1));
				buffer.set_groundwater_index(this->points[0].get_groundwater_index());
				buffer.set_indices(counter, this->points[0].groundwater_elem_index);
				buffer.set_pointer_groundwater_element(this->points[0].groundwater_elem);
				buffer.set_point_name(hyd_label::coupling_point_RV2GW);
				this->set_new_couplingpoint(&buffer);
			}
			counter++;
...
void Hyd_Coupling_Point_RV2GW_List::convert_profiles_index2pointer(Hyd_Model_River *river_model) {
	for (int i = 0; i < this->number; i++) {
...
void Hyd_Coupling_Point_RV2GW_List::transfer_informations2points(void) {
	
	
	for (int i = 0; i < this->number; i++) {
		
		if (this->mid_river_flag == true) {
			this->points[i].transfer_coupling_characteristics_mid();
		}
		else {
...
void Hyd_Coupling_Point_RV2GW_List::reset_coupling_discharge(void) {
	for (int i = 0; i < this->number; i++) {
		this->points[i].reset_coupling_discharge(this->left_river_flag);
	}
}
//Reset the coupling points
void Hyd_Coupling_Point_RV2GW_List::reset_points(void) {
	for (int i = 0; i < this->number; i++) {
...
void Hyd_Coupling_Point_RV2GW_List::syncronisation_models_bylistpoints(const double timepoint, const double delta_t, const bool time_check, const int internal_counter) {
	for (int i = 0; i < this->number; i++) {
...
double Hyd_Coupling_Point_RV2GW_List::get_maximum_h_grad(void) {
	double buffer = 0.0;
...
void Hyd_Coupling_Point_RV2GW_List::merge_coupling_list(Hyd_Coupling_Point_RV2GW_List *merging_list) {
	if (this->defining_polysegment == NULL || merging_list->get_defining_polysegment_gw() == NULL) {
		return;
	}
	//if (this->defining_polysegment == merging_list->get_defining_polysegment_gw()) {
	//	//REVIEW: later task: add the list_rgith and list_left
	//	
	//	return;
	//}
	...
	if (merging_list->get_number_couplings() != 0) {
		...
		//check if the first point of this list is inbetween the merging lists start/end-points
			...
			//find the point
			Hyd_Coupling_Point_RV2GW *buffer;
			Hyd_Coupling_Point_RV2GW new_point;
	...
	for (int i = 0; i < this->number; i++) {
		for (int j = 0; j < merging_list->get_number_couplings(); j++) {
			if (this->points[i] == merging_list->get_couplingpoint(j) && this->points[i].get_groundwater_index() != merging_list->get_couplingpoint(j).get_groundwater_index()) {
...
//Check if the connecting segment between coupling point and groundwater element mid_point is intersecting a river bank_line; a coupling is than not possible 
//TODO check transformation fp to gw polysegment
void Hyd_Coupling_Point_RV2GW_List::check_intercepting_riverbankline2connecting_segment(Hyd_Floodplain_Polysegment *river_bankline) {
	...
	for (int i = 0; i < this->number - 1; i++) {
		...
		if (buffer != NULL) {
			...
			if (intercept_list.get_number_points() > 1) {
				this->points[i + 1].set_pointer_groundwater_element(NULL);
				this->points[i + 1].set_coupling_flag(false);
				this->points[i + 1].set_index_groundwater_element(-1);
			}
...
void Hyd_Coupling_Point_RV2GW_List::clone_list(Hyd_Coupling_Point_RV2GW_List *list, Hyd_Hydraulic_System *system, const int rv_number) {
	_Hyd_Coupling_Point_List_GW::clone_list(list);
	this->left_river_flag = list->left_river_flag;
	this->mid_river_flag = list->mid_river_flag;
	this->allocate_couplingpoints();
	for (int i = 0; i < this->number; i++) {
		this->points[i] = list->points[i];
	}
	Hyd_Model_River *buff_rv = system->get_ptr_river_model(rv_number);
	Hyd_Model_Groundwater *buff_gw = NULL;
	//set the pointer
	for (int i = 0; i < this->number; i++) {
		...
		buff_gw = system->get_ptr_groundwater_model_index(list->points[i].groundwater_index);
		if (buff_gw != NULL) {
			this->points[i].set_pointer_groundwater_element(buff_gw->get_ptr_groundwater_elem(list->points[i].groundwater_elem_index));
		}
		else {
			this->points[i].groundwater_elem = NULL;
		}
	}
	//this->fpl_sec_ids = *(list->get_ptr_fpl_section_ids());
}
//Get pointer to the coupling point specified by the given
Hyd_Coupling_Point_RV2GW* Hyd_Coupling_Point_RV2GW_List::get_ptr_couplingpoint(Hyd_Coupling_Point_RV2GW coupling_point) {
...
void Hyd_Coupling_Point_RV2GW_List::set_list_fpl_sec_id(void) {
...
*/
void Hyd_Coupling_Point_RV2GW_List::output_result2csv_1d(void) {
	...
	//	output_csv.clear();
	//	//open the file
	//	string buffer = this->Param_RV.get_filename_rv2gwcoupling_file_1d(hyd_label::paraview);
	//	//Add time and file type
	//	buffer += "_"+ to_string(this->points[i].point_index);
	//	count = count + 1;
	...
	//		output_csv << " Coupling_info" << ":" << "x_coordination" << ":"<< this->points[i].x_coordinate <<"," << "y_coordination" << ":"<< this->points[i].y_coordinate<< endl;
	//		output_csv << " groundwater_element " << ":" << this->points[i].groundwater_elem_index << endl;
	//		output_csv << "River_profile" << ":"<<this->points[i].get_index_upstream_rvprofile()<<endl;
	//		output_csv << "Time" << label::sec;
	//		output_csv << " groundwater level " << label::m << "," << " river level " << label::m << ",";
	//		output_csv << " riverbed level " << label::m << ",";
	//		output_csv << " section length " << label::m << ",";
	//		output_csv << " wetted perimeter " << label::m << ",";
...
void Hyd_Coupling_Point_RV2GW_List::delete_couplingpoints(void) {
	if (this->points != NULL) {
		delete[]this->points;
		this->points = NULL;
...
void Hyd_Coupling_Point_RV2GW_List::allocate_couplingpoints(void) {
	...
	try {
		this->points = new Hyd_Coupling_Point_RV2GW[full_blocks*this->block_elems];
	}
	catch (bad_alloc &) {
		Error msg = this->set_error(0);
		throw msg;
...
//Get the connecting Geo_Segment between the mid_point of two coupling points and groundwater element mid_point for the given point index
Geo_Segment * Hyd_Coupling_Point_RV2GW_List::get_connecting_segment_point_elem(const int index) {
	Geo_Segment *buffer = NULL;
	...
	if (this->mid_point == *points[index + 1].get_groundwater_element()->get_mid_point()) {
		return buffer = NULL;
	}
	this->connecting_segment.set_points(&this->mid_point, points[index + 1].get_groundwater_element()->get_mid_point());

	return &this->connecting_segment;
}
//Get the mid_point between two coupling points
Geo_Point *Hyd_Coupling_Point_RV2GW_List::get_mid_point(const int index) {
...
void Hyd_Coupling_Point_RV2GW_List::calculate_distances(void) {
...
void Hyd_Coupling_Point_RV2GW_List::verify_merged_list(void) {

	//from end
	for (int i = this->number - 1; i > 0; i--) {
		if (this->points[i].get_groundwater_index() != this->points[i - 1].get_groundwater_index() &&
...
//Set error(s)
Error Hyd_Coupling_Point_RV2GW_List::set_error(const int err_type) {
	string place = "Hyd_Coupling_Point_RV2GW_List::";
	string help;
	string reason;
	int type = 0;
	bool fatal = false;
	...
	switch (err_type) {
	case 0://bad alloc
		place.append("allocate_couplingpoints(void))/set_new_couplingpoint(Hyd_Coupling_Point_RV2GW *new_point)");
