...
//constructor
Hyd_Groundwaterraster_Point_List::Hyd_Groundwaterraster_Point_List(void) :block_elems(50) {
	this->number_points = 0;
	this->points = NULL;
}
//destructor
Hyd_Groundwaterraster_Point_List::~Hyd_Groundwaterraster_Point_List(void) {
	this->delete_points();
}
//___________
//public
//Set a new point in the list
void Hyd_Groundwaterraster_Point_List::set_new_point(_hyd_value2pointindex *new_point) {
...
_hyd_value2pointindex* Hyd_Groundwaterraster_Point_List::get_total_list(void) {
	return this->points;
}
//Get a point with a given index
_hyd_value2pointindex Hyd_Groundwaterraster_Point_List::get_point(const int index) {
	return this->points[index];
}
//Get the number of points stored in the list
int Hyd_Groundwaterraster_Point_List::get_number_points(void) {
	return this->number_points;
}
//Delete the list
void Hyd_Groundwaterraster_Point_List::delete_list(void) {
	this->number_points = 0;
	this->delete_points();
}
//Output members
void Hyd_Groundwaterraster_Point_List::output_members(void) {
...
//private
//Delete the points
void Hyd_Groundwaterraster_Point_List::delete_points(void) {
	if (this->points != NULL) {
		delete[] this->points;
		this->points = NULL;
	}
...
//Allocate the points
void Hyd_Groundwaterraster_Point_List::allocate_points(void) {
	try {
...
//Set error(s)
Error Hyd_Groundwaterraster_Point_List::set_error(const int err_type) {
	string place = "Hyd_Groundwaterraster_Point_List::";
	string help;
	string reason;
	int type = 0;
	bool fatal = false;
