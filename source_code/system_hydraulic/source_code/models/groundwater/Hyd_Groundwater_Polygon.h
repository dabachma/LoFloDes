#pragma once
/**\class Hyd_Groundwater_Polygon
	\author Bastian Winkels
	\author produced by the Institute of Hydraulic Engineering (IWW), RWTH Aachen University
	\version 0.10.0
	\date 2022
*/
#ifndef HYD_GROUNDWATER_POLYGON_H
#define HYD_GROUNDWATER_POLYGON_H
...
*/
class Hyd_Groundwater_Polygon : public Geo_Convex_Polygon
{
public:
	///Default constructor
	Hyd_Groundwater_Polygon(void);
	///Default destructor
	~Hyd_Groundwater_Polygon(void);
	...
	void set_elementtype_inside(_hyd_gw_elem_type elementtype);
	///Get the element type (_hyd_gw_elem_type) of the elements which are inside
	_hyd_gw_elem_type get_elementtype_inside(void);

	///Clone the groundwater-polygon
	void clone_polygon(Hyd_Groundwater_Polygon *poly);
...
private:
	...
	///Index of the groundwater polygon
	int index;
	///Type of the elements (_hyd_gw_elem_type) which are in the polygon
	_hyd_gw_elem_type elementtype_inside;
